...
const AddActivities = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    let imageURL = "";
    if (image) {
      imageURL = await uploadImage(image); // Function to upload image and return the image URL
    }
    const activities = {
      name,
      description,
    ...
    const result = await createAdminactivitiesDocument(activities);
